...
#define yyparse         jcamp_yyparse
#define yylex           jcamp_yylex
#define yyerror         jcamp_yyerror
#define yydebug         jcamp_yydebug
#define yynerrs         jcamp_yynerrs
 ...
 */
/*! \file       jcamp.y
 * \brief       jcamp-dx grammar definition
 *
 */
#include <stdio.h>
...
static void jcamp_yyerror(_YYLTYPE * yylloc, Ldrset & jdx, yyscan_t scanner, const char *s);
#define YYLLOC_DEFAULT(Current, Rhs, NN) FILELOC_YYLLOC_DEFAULT(jdx, Current, Rhs, NN)
...
do                                                              \
  if (yychar == YYEMPTY)                                        \
    ...
    {                                                           \
      yyerror (&yylloc, jdx, scanner, YY_("syntax error: cannot back up")); \
      YYERROR;                                                  \
    }                                                           \
while (0)
  ...
  if (yydebug)                                                            \
    {                                                                     \
      ...
      yy_symbol_print (stderr,                                            \
                  Type, Value, Location, jdx, scanner); \
      YYFPRINTF (stderr, "\n");                                           \
    }                                                                     \
} while (0)
...
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, Ldrset & jdx, yyscan_t scanner)
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
  YYUSE (yylocationp);
...
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, Ldrset & jdx, yyscan_t scanner)
{
  ...
  YYFPRINTF (yyoutput, ": ");
  yy_symbol_value_print (yyoutput, yytype, yyvaluep, yylocationp, jdx, scanner);
  YYFPRINTF (yyoutput, ")");
}
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, Ldrset & jdx, yyscan_t scanner)
{
  ...
  for (yyi = 0; yyi < yynrhs; yyi++)
    {
      ...
      yy_symbol_print (stderr,
                       ...
                       &(yyvsp[(yyi + 1) - (yynrhs)])
                       , &(yylsp[(yyi + 1) - (yynrhs)])                       , jdx, scanner);
      YYFPRINTF (stderr, "\n");
    }
}
...
do {                                    \
  if (yydebug)                          \
    yy_reduce_print (yyssp, yyvsp, yylsp, Rule, jdx, scanner); \
} while (0)
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, Ldrset & jdx, yyscan_t scanner)
{
  YYUSE (yyvaluep);
  YYUSE (yylocationp);
  YYUSE (jdx);
...
int
yyparse (Ldrset & jdx, yyscan_t scanner)
{
  ...
  if (yychar == YYEMPTY)
    {
      ...
      yychar = yylex (&yylval, &yylloc, jdx, scanner);
    }
...
#line 96 "src/jcamp.y" /* yacc.c:1646  */
    {
          if ((yyvsp[0].ldr)->size()) {
            (yyval.ldr) = (yyvsp[0].ldr);
            (yyval.ldr)->setShape(*(yyvsp[-1].ldr));
          } else {
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (&yylloc, jdx, scanner, YY_("syntax error"));
#else
# define YYSYNTAX_ERROR yysyntax_error (&yymsg_alloc, &yymsg, \
                                        yyssp, yytoken)
      {
        ...
        yyerror (&yylloc, jdx, scanner, yymsgp);
      ...
      if (yychar <= YYEOF)
      ...
      else
        {
          yydestruct ("Error: discarding",
                      yytoken, &yylval, &yylloc, jdx, scanner);
          yychar = YYEMPTY;
        }
    }
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  yystos[yystate], yyvsp, yylsp, jdx, scanner);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
...
`-------------------------------------------------*/
yyexhaustedlab:
  yyerror (&yylloc, jdx, scanner, YY_("memory exhausted"));
  yyresult = 2;
  /* Fall through.  */
#endif
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  yystos[*yyssp], yyvsp, yylsp, jdx, scanner);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
